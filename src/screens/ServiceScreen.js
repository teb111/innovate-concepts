      ...
      <div className="page-container">
        ...
        <TabPanel value={value} index={0}>
          <div className="mt-4">
            <img
              src={
                "https://res.cloudinary.com/teb/image/upload/v1716741190/Architecture_x7upbc.jpg"
              }
              className="w-100 services-img"
              alt="work"
            />
          </div>
        ...
        <TabPanel value={value} index={1}>
          <div className="mt-4">
            <img
              src={
                "https://res.cloudinary.com/teb/image/upload/v1716741189/Engineering_lit3do.jpg"
              }
              className="w-100 services-img"
              alt="work"
            />
        ...
        <TabPanel value={value} index={2}>
          <div className="mt-4">
            <img
              src={
                "https://res.cloudinary.com/teb/image/upload/v1716741191/Project_mgt_llp1yp.jpg"
              }
              className="w-100 services-img"
              alt="work"
            />
        ...
        <TabPanel value={value} index={3}>
          <div className="mt-4">
            <img
              src={
                "https://res.cloudinary.com/teb/image/upload/v1716741198/Construction_wgk6vg.jpg"
              }
              className="w-100 services-img"
              alt="work"
            />
